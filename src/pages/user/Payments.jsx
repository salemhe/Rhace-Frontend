    ...
    >
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto px-4 pt-5 pb-6">
          ...
          >
            <button className={` ${s.label === "Pending" ? "border-gray-100 bg-gray-50 hover:bg-gray-100 text-gray-500" : "bg-[#0A6C6D] hover:bg-[#085a66] text-white shadow-[#0A6C6D]/25"} flex-1 flex items-center justify-center gap-2 py-3.5 rounded-2xl font-bold text-sm transition-all shadow-lg `}>
