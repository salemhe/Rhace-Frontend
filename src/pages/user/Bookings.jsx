  ...
  return (
    <div className="relative border-b border-gray-200">
      <div className="flex items-center gap-2 px-4 sm:px-6 py-3 bg-gray-50">
        ...
        <button
          onClick={onClose}
          className="ml-1 text-xs text-gray-500 hover:text-gray-800 font-medium transition-colors"
        >
          Cancel
        </button>
      </div>
        ...
        {isLoading ? (
          ...
          <>
            ...
            <div className="overflow-visible">
              ...
              {/* Booking cards */}
              <div
                key={`${activeTab}-${searchQuery}-${typeFilter}-${dateFrom}-${dateTo}`}
                className="pt-4 cards-enter"
              >
                {displayBookings.length === 0 ? (
