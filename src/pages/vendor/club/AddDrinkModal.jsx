...
export function AddDrinkModal({
  ...
  const [addOns, setAddOns] = useState({
    iceBucket: initialData.addOns.includes("iceBucket"),
    chaser: initialData.addOns.includes("chaser"),
    sprinklers: initialData.addOns.includes("sprinklers"),
    glassware: initialData.addOns.includes("glassware"),
  });
  ...
  const handleImageUpload = useCallback(async (files, setImage) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      let response;
      if (editMode) {
        payload.drinkId = initialData._id;
        response = await clubService.updateDrinkType(payload);
      } else {
        response = await clubService.createDrinkType(payload);
      }
      ...
      if (err.response?.status === 403) {
        setError(
          "You do not have permission to add drinks. Please contact your administrator.",
        );
          ...
          <div>
            ...
            >
              ...
              <input
                ...
                onChange={(e) =>
                  e.target.files &&
                  handleImageUpload(e.target.files, setFormData)
                }
            ...
            <div className="flex items-center justify-between mb-3">
              <div>
                ...
                <p className="text-xs text-gray-500">
                  Include addons for your drinks
                </p>
              </div>
          ...
          <div>
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-gray-500">
                  Make this drink visible on booking screen
                </p>
              </div>
              <label className="relative inline-flex items-center cursor-pointer">
                <input
