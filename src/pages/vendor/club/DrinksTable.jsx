...
// import { AddBottleSetModal } from './AddBottleSetModal';
      ...
      <div className="max-w-7xl mx-auto p-6">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              onClick={() => setShowAddBottleSetModal(true)}
            ...
            <tbody className="divide-y divide-gray-200">
              {filteredDrinks.map((drink) => (
                <tr key={drink.id} className="hover:bg-gray-50 transition-colors">
                  ...
                  <td className="px-4 py-4">
                    <img
                      src={drink.image_url || 'https://images.pexels.com/photos/338713/pexels-photo-338713.jpeg?auto=compress&cs=tinysrgb&w=400'}
                      alt={drink.name}
