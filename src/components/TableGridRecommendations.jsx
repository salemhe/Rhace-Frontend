...
const TableGrid = ({ title, data: restaurants }) => {
...
export const TableGridTwo = ({ title, data: restaurants }) => {
    const { currentIndices, handleMouseEnter, handleMouseLeave, handleDotClick } =
        useCarouselLogic();
    const [isLoading, setIsLoading] = useState(true);
    const navigate = useNavigate();
...
export const TableGridThree = ({ title, data: restaurants }) => {
    const { currentIndices, handleMouseEnter, handleMouseLeave, handleDotClick } =
        useCarouselLogic();
    const [isLoading, setIsLoading] = useState(true);
    // const navigate = useNavigate();
