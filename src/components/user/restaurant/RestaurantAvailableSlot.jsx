...
export default function RestauranAvalableSlot({
  ...
  return (
    <div className="flex flex-col font-(--font-inter) gap-6">
      <div className="bg-[#E8FFE1] rounded-xl border border-[#72E94E] flex flex-col sm:flex-row sm:items-center sm:w-fit p-4 sm:p-3 gap-4">
        <div>
          <svg
            width="34"
            height="34"
